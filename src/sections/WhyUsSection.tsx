  ...
  return (
    <section id="why-us" className="relative overflow-hidden bg-ink">
      ...
      <div className="section-shell">
          ...
          {differentiators.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-4 font-display text-2xl font-bold text-white">{item.title[locale]}</h3>
        ...
        <div className="mt-10 rounded-lg border border-leaf/25 bg-leaf/10 p-6">
          <h3 className="font-display text-3xl font-bold text-white">{t('why.kidsTitle')}</h3>
