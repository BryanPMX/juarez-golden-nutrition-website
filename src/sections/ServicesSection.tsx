          ...
          {plans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                <p className={`mt-5 flex items-center justify-start gap-3 font-display text-3xl font-bold sm:mt-6 sm:text-4xl ${plan.accent === 'leaf' ? 'text-leaf-light' : 'text-gold-light'}`}>
                ...
                <p className="mt-1 text-left text-sm font-semibold text-white/60">{plan.duration[locale]}</p>
